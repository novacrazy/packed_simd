...
impl_shuffle! { [u32; 128], i8, crate::codegen::i8x128 }
...
impl_shuffle! { [u32; 128], u8, crate::codegen::u8x128 }
...
impl_shuffle! { [u32; 128], m8, crate::codegen::m8x128 }
...
impl_shuffle! { [u32; 64], i16, crate::codegen::i16x64 }
...
impl_shuffle! { [u32; 64], u16, crate::codegen::u16x64 }
...
impl_shuffle! { [u32; 32], m16, crate::codegen::m16x32 }
...
impl_shuffle! { [u32; 32], i32, crate::codegen::i32x32 }
...
impl_shuffle! { [u32; 32], u32, crate::codegen::u32x32 }
...
impl_shuffle! { [u32; 32], f32, crate::codegen::f32x32 }
...
impl_shuffle! { [u32; 32], m32, crate::codegen::m32x32 }
...
impl_shuffle! { [u32; 16], i64, crate::codegen::i64x16 }
...
impl_shuffle! { [u32; 16], u64, crate::codegen::u64x16 }
...
impl_shuffle! { [u32; 16], f64, crate::codegen::f64x16 }
...
impl_shuffle! { [u32; 16], m64, crate::codegen::m64x16 }
...
impl_shuffle! { [u32; 16], isize, crate::codegen::isizex16 }
...
impl_shuffle! { [u32; 16], usize, crate::codegen::usizex16 }
...
impl_shuffle! { [u32; 16], msize, crate::codegen::msizex16 }
...
impl<T> Seal<[u32; 16]> for *const T {}
impl<T> Shuffle<[u32; 16]> for *const T {
    type Output = crate::codegen::cptrx16<T>;
}
...
impl<T> Seal<[u32; 16]> for *mut T {}
impl<T> Shuffle<[u32; 16]> for *mut T {
    type Output = crate::codegen::mptrx16<T>;
}
...
impl_shuffle! { [u32; 8], i128, crate::codegen::i128x8 }
...
impl_shuffle! { [u32; 8], u128, crate::codegen::u128x8 }
...
impl_shuffle! { [u32; 8], m128, crate::codegen::m128x8 }
